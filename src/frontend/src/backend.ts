...
export class Backend implements backendInterface {
    ...
    async addApp(arg0: string, arg1: Blob, arg2: string, arg3: boolean, arg4: number, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addApp(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeApp(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.removeApp(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateApp(arg0: bigint, arg1: string, arg2: Blob, arg3: string, arg4: boolean, arg5: number, arg6: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateApp(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
